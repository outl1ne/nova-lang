!(function(t) {
  ...
  function(t, e, n) {
    Nova.booting(function(t, e, r) {
      t.component('locale-dropdown', n(5));
    });
  },
  function(t, e, n) {
    var r = n(0)(
  ...
  function(t, e, n) {
    (t.exports = n(8)(!1)).push([
      t.i,
      '.navigation-dropdown-nova-lang[data-v-5df48445]{height:25px;overflow:hidden;user-select:none}.active[data-v-5df48445]{height:unset;overflow:unset}',
      '',
    ]);
  },
  function(t, e) {
  ...
  function(t, e, n) {
    ...
    function m(t) {
      ...
      if (p) {
        var o = c++;
        (r = s || (s = v())), (e = _.bind(null, r, o, !1)), (n = _.bind(null, r, o, !0));
      } else
        (r = v()),
          (e = function(t, e) {
            var n = e.css,
  ...
  function(t, e, n) {
    ...
    e.default = {
      props: ['locales', 'newLocale'],
      name: 'Navigation',
      data: function() {
        return { activeLocale: void 0, localeParent: void 0, isActive: !1, resourceName: null };
      },
      methods: {
        ...
        setActiveLocale: function(t) {
          var e = this;
          Nova.request()
            .post('/nova-vendor/nova-lang/novaLangUpdateActiveLocale/' + t)
            .then(
              function(n) {
                e.$store.commit('setLocale', t);
              },
              function() {
                e.$toasted.show('Failed to update selected locale!', { type: 'error' });
              }
            );
        },
                  ...
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        return (
                          (t.prev = 0),
                          t.abrupt('return', Nova.request().get('/nova-vendor/nova-lang/novaLangGetActiveLocale'))
                        );
                      case 4:
                        (t.prev = 4),
                          (t.t0 = t.catch(0)),
                  ...
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        return (
                          (t.prev = 0),
                          t.abrupt('return', Nova.request().get('/nova-vendor/nova-lang/novaLangGetAllLocales'))
                        );
                      case 4:
                        (t.prev = 4), (t.t0 = t.catch(0)), this.$toasted.show(t.t0, { type: 'error' });
                      case 7:
                      case 'end':
                        return t.stop();
                    }
              ...
              return o.a.wrap(
                function(t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        if (((this.resourceName = this.$router.currentRoute.params.resourceName), !this.resourceName)) {
                          t.next = 9;
                          break;
                        }
                        return (
                          (e = _.cloneDeep(this.$store.getters[this.resourceName + '/filters'])),
                          (n = _.cloneDeep(e)).push({}),
                          (t.next = 7),
                          this.$store.commit(this.resourceName + '/storeFilters', n)
                        );
                      case 7:
                        return (t.next = 9), this.$store.commit(this.resourceName + '/storeFilters', e);
                      case 9:
                      case 'end':
                        return t.stop();
                    }
      ...
      watch: {
        getLocale: function(t) {
          (this.activeLocale = t), this.setActiveLocale(t), this.reloadResources();
        },
        $route: (function() {
          var t = s(
              ...
              return o.a.wrap(
                function(t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        if (void 0 !== this.activeLocale) {
                          t.next = 4;
                          break;
                        }
                        return (t.next = 3), this.getActiveLocale();
                      case 3:
                        this.activeLocale = t.sent.data;
                      case 4:
                        if (void 0 === e.query.locale || this.activeLocale === e.query.locale) {
                          t.next = 10;
                          break;
                        }
                        return (t.next = 7), this.getAllLocales();
                      case 7:
                        (n = t.sent.data),
                          Object.keys(n).includes(e.query.locale)
                            ? this.setActiveLocale(e.query.locale)
      ...
      computed: a({}, Object(i.a)({ getLocale: 'nova-lang/nova-lang-storage/getLocale' })),
    };
  },
  function(t, e, n) {
    t.exports = n(13);
  ...
  function(t, e, n) {
    ...
    if (((r.regeneratorRuntime = void 0), (t.exports = n(14)), o)) r.regeneratorRuntime = i;
    else
      try {
  ...
  function(t, e) {
    !(function(e) {
      ...
      if (f) u && (t.exports = f);
        ...
        var _ = (E.prototype = x.prototype = Object.create(m));
        (L.prototype = _.constructor = E),
          (E.constructor = L),
          (E[c] = L.displayName = 'GeneratorFunction'),
    ...
    t.exports = {
      render: function() {
        ...
        return n(
          ...
          {
            staticClass:
              'cursor-pointer items-center font-normal text-white mb-6 text-base no-underline navigation-dropdown-nova-lang',
          ...
          [
            n(
              'h3',
              {
                staticClass: 'flex items-center font-normal text-white mb-6 text-base no-underline',
                on: {
                  click: function(e) {
              ...
              [
                ...
                t._v(' '),
                n('span', { staticClass: 'sidebar-label dim items-center' }, [
                  t._v(' ' + t._s(t.locales[t.activeLocale]) + ' '),
                ]),
              ]
            ),
            t._v(' '),
            n('div', [
              n(
                'ul',
                { staticClass: 'list-reset mb-8' },
                t._l(t.locales, function(e, r) {
                  return n(
                    'li',
                    {
                      staticClass: 'leading-wide mb-4 text-sm ml-8 no-underline dim',
                      class: { 'router-link-exact-active router-link-active': t.locales[t.activeLocale] === e },
                      on: {
                        click: function(e) {
                          return t.setActiveLocale(r);
                        },
                      },
                    },
                    [t._v('\n        ' + t._s(e) + '\n      ')]
